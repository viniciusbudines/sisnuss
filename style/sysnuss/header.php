<?php /* $Id: header.php 1996 2011-07-18 07:18:05Z caseydk $ $URL: https://web2project.svn.sourceforge.net/svnroot/web2project/tags/version2.4/style/wps-redmond/header.php $ */
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body onload="this.focus();">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="center">
                    <table  class="banner" width='99%' cellpadding="3" cellspacing="2" border="0">
                    <tr>
                        <th align="left"><strong><a href='http://www.nuss.com.br/sysnuss' <?php if ($dialog)
                        echo "target='_blank'"; ?>><?php
                        echo '<a href="http://www.nuss.com.br/sysnuss">' . w2PtoolTip('sysNUSS v. ' . $AppUI->getVersion(), utf8_encode(' Clique para suporte'), true) . '<img src="style/' . $uistyle . '/images/title.png" border="0" alt="suporte"  /></a>';?>
                        </th>
                        <? if(!$dialog) { ?>
                        <th align="left">
                        ...
                        <?php if ($AppUI->user_id > 0) { ?>
                                    <th width="170" valign="middle" nowrap="nowrap"><table><tr><td><form name="frm_search" action="?m=smartsearch" method="post" accept-charset="utf-8">

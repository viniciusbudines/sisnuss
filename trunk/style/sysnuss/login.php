<?php /* $Id: login.php 1938 2011-05-31 04:21:39Z caseydk $ $URL: https://web2project.svn.sourceforge.net/svnroot/web2project/tags/version2.4/style/wps-redmond/login.php $ */
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <title><?php echo $w2Pconfig['company_name']; ?> :: sysNUSS Login</title>
    ...
    <body bgcolor="#f0f0f0" onload="document.loginform.username.focus();">
        <table width="100%" cellspacing="0" cellpadding="3" border="0">
            <tbody>
                <tr>
                    <td align="center" width="508"><a href="http://www.nuss.com.br/sysnuss"><img border="0" alt="sysNUSS WebSite" src="./style/<?php echo $uistyle; ?>/images/sysnuss.png"/></a></td>
                </tr>
            </tbody>
        </table>
        ...
        <form method="post" action="<?php echo $loginFromPage; ?>" name="loginform" accept-charset="utf-8">
            <table style="border-style:none;" align="center" border="0" width="250" cellpadding="0" cellspacing="0" class="std">
                ...
                <tr>
                    <td style="padding:6px" align="left" nowrap="nowrap"></td>
